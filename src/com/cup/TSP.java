...
public class TSP {
    ...
    static class toRun implements Callable<Double> {
        ...
        @Override
        public Double call() {
            AntColony antColony = new AntColony(seed);
            antColony.setupColony(title);
            antColony.runAntColony();
//            setBestWalk(antColony.bestWalk);
            return antColony.bestLength;
        }
    }
    ...
    private void verifySolution() throws ExecutionException, InterruptedException {
        String[] titles = {
                "ch130.tsp",
                "d198.tsp",
                "eil76.tsp",
